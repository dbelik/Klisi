...
export default function Welcome() {
    return (
        <section 
            ...
            style={{ height: "100vh" }}
        >
            <div className="d-flex flex-column flex-wrap align-items-center justify-content-center w-100 h-100">
                ...
                <div className="d-flex align-items-center justify-content-center col-lg-6 pl-5 pr-3 order-first order-lg-last mb-5 mb-lg-0">
                    <HomeEye />
                </div>
            </div>
        </section>
